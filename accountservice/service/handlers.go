...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/bailaohe/goblog/common"
)
...
func HealthCheck(w http.ResponseWriter, r *http.Request) {
	...
	servBy := common.GetIP()
	if dbUp && isHealthy {
			data, _ := json.Marshal(healthCheckResponse{Status: "UP", ServBy: servBy})
		writeJsonResponse(w, http.StatusOK, data)
	} else {
		data, _ := json.Marshal(healthCheckResponse{Status: "Database unaccessible", ServBy: servBy})
